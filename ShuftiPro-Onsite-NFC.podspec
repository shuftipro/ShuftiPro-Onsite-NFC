...
spec.name         = "ShuftiPro-Onsite-NFC"
spec.version      = "1.0.0"
...
spec.homepage     = "https://github.com/shuftipro/ShuftiPro-Onsite-NFC"
...
spec.source       = { :git => "https://github.com/shuftipro/ShuftiPro-Onsite-NFC.git", :tag => "#{spec.version}" }
